...
I built the whole thing on **Next.js 15** with **TypeScript**, backed by **PostgreSQL** through **Prisma ORM**. The Prisma schema alone is 1,752 lines across 49+ models. The app has 289+ API routes, real-time messaging with **Socket.io**, and supports three languages out of the box.
